...
{
    [TestFixture]
    public class SolveByDigitRestrictedToColumnsInBoxes
    {
...
";
        ...
        [Test]
        public void WhenADigitWillPotentiallyAppearInOnlyTwoOfTheColumnsForTwoBoxes_ThenItCanBeRemovedFromThoseColumnsInTheThirdBox()
        {
            var grid = GridBuilder.BuildFromDefinition(exampleGrid);
            grid.Tidy();
            ...
            grid.ConfirmPossibilities(6, 4, new[] { 1,4,6,7}, "Removed 3");
            grid.ConfirmPossibilities(7,3, new [] { 1,7}, "Removed 3");
            grid.ConfirmPossibilities(7,4,new [] { 1,4,6,7}, "Removed 3");
        }
    }
}
