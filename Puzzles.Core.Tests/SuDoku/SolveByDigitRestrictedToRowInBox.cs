...
{
    [TestFixture]
    public class SolveByDigitRestrictedToRowInBox
    {
...
";
        ...
        private readonly ISolver solver = new DigitRestrictedToRowInBoxSolver();
        ...
        public void WhenThereIsADigitRestrictedToAGivenColumnWithinABox_ThenTheDigitIsRemovedFromTheColumnInOtherBoxes()
        {
            ...
            grid.ConfirmPossibilities(2, 6, new [] { 6,8}, "Removed 3 because it must be in the bottom row in the middle box");
        }
    }
}
